...
const VideoUpload: React.FC<VideoUploadProps> = ({
  ...
  return (
    <div className="flex items-center justify-center  bg-imdb-black">
      <div className="bg-imdb-black-light rounded-2xl shadow-lg border border-imdb-black-lighter w-1/2">
        {/* Header */}
        ...
        <div className="p-6">
          ...
          >
            ...
            {isDragActive ? (
              <div>
                <p className="text-lg font-medium text-imdb-gold">
          ...
          <div className="px-6 pb-6">
            ...
            <div className="space-y-4">
              {uploads.map((upload, index) => (
                <div
                  key={index}
                  className="bg-imdb-black-lighter rounded-xl p-4 border border-imdb-black-lighter hover:border-imdb-gold/50 transition-all duration-300"
                >
